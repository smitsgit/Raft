"""
At present using this module which makes use of Python multiprocessing to achieve
the RPC.

Not really sure but I am also thinking of using RabbitMQ with producers / consumers
in RPC mode.
"""
...
#
# def init():
#     serv = RPCServer(address=("localhost", 0), authkey=b"peekaboo")
#     print("listening on {}".format(serv.address))
